...
create_test("WindowedApp", "Graphics_RendererAndResourceManager", {"lib"}, {besdkdir, "glew-1.11.0/include", "include"}, {"test/graphics/rendererandresourcemanager.cpp", "test/graphics/data/*.*"}, {"besdkClient", "glew32", "opengl32"}, {"besdkClientD", "glew32d", "opengl32"}, {}, "test/graphics");
